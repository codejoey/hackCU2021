...
export default function Health() {
    ...
    return (
        <View style={styles.container}>
            ...
            <TouchableOpacity><Text style={{backgroundColor:'#B5D0DE', height:50, color:'#FFF', fontWeight:'900', 
            ...
            <View style={{borderRadius:20, borderWidth:2,borderColor:'#2193D1', height:100, width:'45%', padding:'7.5%', marginRight:'2.5%'}}>
            ...
            <View style={{borderRadius:20, borderWidth:2,borderColor:'#2193D1', height:100, width:'45%', padding:'7.5%'}}>
            ...
            <View style={{borderRadius:20, borderWidth:2,borderColor:'#2193D1', height:100, width:'92%', padding:'7.5%', marginTop:'5%'}}>
